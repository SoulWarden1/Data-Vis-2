var vg_1 = "vega-lite/melb_cafes.vg.json";
vegaEmbed("#melb_cafes", vg_1).then(function(result) {}).catch(console.error);

var vg_2 = "vega-lite/melb_cafes_over_time.vg.json";
vegaEmbed("#melb_cafes_over_time", vg_2).then(function(result) {}).catch(console.error);
...
var vg_6 = "vega-lite/top_suburbs_per_capita.vg.json";
vegaEmbed("#top_suburbs_per_capita", vg_6).then(function(result) {}).catch(console.error);
